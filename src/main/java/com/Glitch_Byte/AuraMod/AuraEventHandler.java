...
public class AuraEventHandler implements IWorldGenerator
{
	@Override
	...
	{
		addOreSpawn(AuraMod.AuraStone.getDefaultState(), Blocks.stone, world, random, x, z, 16, 16, 5 + random.nextInt(5), 4, 10, 60);
	}
